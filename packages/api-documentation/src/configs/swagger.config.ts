...
const swaggerUiOptions = {
    ...
    definition: {
        ...
        info: {
            ...
            version: '1.0.0',
            description:
                'This module serves auto-generated swagger-ui generated API docs from Thub express backend, based on a swagger.yml file. Swagger is available on: http://localhost:6655/api-docs',
            contact: {
                name: 'ThubAI',
