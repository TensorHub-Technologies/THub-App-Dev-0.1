...
const getSingleFlowConfig = async (chatflowId) => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: flowConfigService.getSingleFlowConfig - ${(0, utils_2.getErrorMessage)(error)}`);
    }
};
exports.default = {
    getSingleFlowConfig
