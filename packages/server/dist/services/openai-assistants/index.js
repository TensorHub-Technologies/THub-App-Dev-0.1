...
const getAllOpenaiAssistants = async (credentialId) => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: openaiAssistantsService.getAllOpenaiAssistants - ${(0, utils_2.getErrorMessage)(error)}`);
    }
};
...
const getSingleOpenaiAssistant = async (credentialId, assistantId) => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: openaiAssistantsService.getSingleOpenaiAssistant - ${(0, utils_2.getErrorMessage)(error)}`);
    }
};
