...
const generateAgentflowv2 = async (question, selectedChatModel) => {
    try {
        ...
        if (process.env.MODE === Interface_1.MODE.QUEUE) {
            ...
            response = await (0, thub_components_1.generateAgentflowv2)({ prompt, componentNodes: (0, getRunningExpressApp_1.getRunningExpressApp)().nodesPool.componentNodes, toolNodes, selectedChatModel }, question, options);
        }
        try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: generateAgentflowv2 - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
exports.default = {
    generateAgentflowv2
