...
const createDocumentStore = async (newDocumentStore) => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.createDocumentStore - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
const getAllDocumentStores = async (page = -1, limit = -1, tenantId) => {
    try {
        const appServer = (0, getRunningExpressApp_1.getRunningExpressApp)();
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.getAllDocumentStores - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
...
const deleteLoaderFromDocumentStore = async (storeId, docId) => {
    try {
        ...
        if (!entity) {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.NOT_FOUND, `Error: documentStoreServices.deleteLoaderFromDocumentStore - Document store ${storeId} not found`);
        }
        ...
        if (found) {
            if (found.files?.length) {
                for (const file of found.files) {
                    if (file.name) {
                        try {
                            await (0, thub_components_1.removeSpecificFileFromStorage)(constants_1.DOCUMENT_STORE_BASE_FOLDER, storeId, file.name);
                        }
                        catch (error) {
                            console.error(error);
                        }
            ...
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Unable to locate loader in Document Store ${entity.name}`);
        }
    }
    catch (error) {
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.deleteLoaderFromDocumentStore - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
const getDocumentStoreById = async (storeId) => {
    try {
        ...
        if (!entity) {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.NOT_FOUND, `Error: documentStoreServices.getDocumentStoreById - Document store ${storeId} not found`);
        }
        return entity;
    }
    catch (error) {
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.getDocumentStoreById - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
const getUsedChatflowNames = async (entity) => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.getUsedChatflowNames - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
...
const getDocumentStoreFileChunks = async (appDataSource, storeId, docId, pageNo = 1) => {
    try {
        ...
        if (docId !== 'all') {
            ...
            if (!found) {
                throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.NOT_FOUND, `Error: documentStoreServices.getDocumentStoreById - Document loader ${docId} not found`);
            }
        }
        if (found) {
            found.id = docId;
        ...
        if (!chunksWithCount) {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.NOT_FOUND, `Chunks with docId: ${docId} not found`);
        }
        const response = {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.getDocumentStoreFileChunks - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
const deleteDocumentStore = async (storeId) => {
    try {
        ...
        if (!entity) {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.NOT_FOUND, `Document store ${storeId} not found`);
        }
        try {
            (0, thub_components_1.removeFilesFromStorage)(constants_1.DOCUMENT_STORE_BASE_FOLDER, entity.id);
        }
        catch (error) {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.deleteDocumentStore - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
const deleteDocumentStoreFileChunk = async (storeId, docId, chunkId) => {
    try {
        ...
        if (!found) {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.NOT_FOUND, `Document store loader ${docId} not found`);
        }
        const tbdChunk = await appServer.AppDataSource.getRepository(DocumentStoreFileChunk_1.DocumentStoreFileChunk).findOneBy({
            id: chunkId
        });
        if (!tbdChunk) {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.NOT_FOUND, `Document Chunk ${chunkId} not found`);
        }
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.deleteDocumentStoreFileChunk - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
const deleteVectorStoreFromStore = async (storeId) => {
    try {
        ...
        if (!entity.embeddingConfig) {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.NOT_FOUND, `Embedding for Document store ${storeId} not found`);
        }
        if (!entity.vectorStoreConfig) {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.NOT_FOUND, `Vector Store for Document store ${storeId} not found`);
        }
        if (!entity.recordManagerConfig) {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.NOT_FOUND, `Record Manager for Document Store ${storeId} is needed to delete data from Vector Store`);
        }
        const options = {
            chatflowid: storeId,
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.deleteVectorStoreFromStore - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
const editDocumentStoreFileChunk = async (storeId, docId, chunkId, content, metadata) => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.editDocumentStoreFileChunk - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
const updateDocumentStore = async (documentStore, updatedDocumentStore) => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.updateDocumentStore - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
const _saveFileToStorage = async (fileBase64, entity) => {
    ...
    (0, thub_components_1.addSingleFileToStorage)(mime, bf, filename, constants_1.DOCUMENT_STORE_BASE_FOLDER, entity.id);
    return {
        id: (0, uuid_1.v4)(),
        name: filename,
        mimePrefix: mime,
...
const _splitIntoChunks = async (appDataSource, componentNodes, data) => {
    try {
        ...
        // doc loader configs
        const nodeData = {
            credential: data.credential || data.loaderConfig['THUB_CREDENTIAL_ID'] || undefined,
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.splitIntoChunks - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
    ...
    for (let i = 0; i < keys.length; i++) {
        ...
        if (input.startsWith('FILE-STORAGE::')) {
            if (!documentStoreEntity) {
                ...
                if (!documentStoreEntity) {
                    throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.NOT_FOUND, `Document store ${data.storeId} not found`);
                }
            }
            ...
            if (currentLoader) {
                ...
                for (const file of files) {
                    const bf = await (0, thub_components_1.getFileFromStorage)(file, constants_1.DOCUMENT_STORE_BASE_FOLDER, documentStoreEntity.id);
...
const previewChunksMiddleware = async (data) => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.previewChunksMiddleware - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
const previewChunks = async ({ appDataSource, componentNodes, data }) => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.previewChunks - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
...
const saveProcessingLoader = async (appDataSource, data) => {
    try {
        ...
        if (!entity) {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.NOT_FOUND, `Error: documentStoreServices.saveProcessingLoader - Document store ${data.storeId} not found`);
        }
        const existingLoaders = JSON.parse(entity.loaders);
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.saveProcessingLoader - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
const processLoader = async ({ appDataSource, componentNodes, data, docLoaderId }) => {
    ...
    if (!entity) {
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.NOT_FOUND, `Error: documentStoreServices.processLoader - Document store ${data.storeId} not found`);
    }
...
const processLoaderMiddleware = async (data, docLoaderId, isInternalRequest = false) => {
    try {
        const appServer = (0, getRunningExpressApp_1.getRunningExpressApp)();
        const appDataSource = appServer.AppDataSource;
        const componentNodes = appServer.nodesPool.componentNodes;
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.processLoader - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
const _saveChunksToStorage = async (appDataSource, componentNodes, data, entity, newLoaderId) => {
    ...
    try {
                ...
                if (!data.rehydrated) {
                    if (loader.files) {
                        loader.files.map(async (file) => {
                            try {
                                await (0, thub_components_1.removeSpecificFileFromStorage)(constants_1.DOCUMENT_STORE_BASE_FOLDER, entity.id, file.name);
                            }
                            catch (error) {
                                console.error(error);
                            }
        ...
        if (response.chunks) {
            ...
            await Promise.all(response.chunks.map(async (chunk, index) => {
                try {
                    ...
                    throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices._saveChunksToStorage - ${(0, utils_1.getErrorMessage)(chunkError)}`);
                }
            }));
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices._saveChunksToStorage - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
...
const getDocumentLoaders = async () => {
    ...
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.getDocumentLoaders - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
const updateDocumentStoreUsage = async (chatId, storeId) => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.updateDocumentStoreUsage - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
const updateVectorStoreConfigOnly = async (data) => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.updateVectorStoreConfig - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
const saveVectorStoreConfig = async (appDataSource, data, isStrictSave = true) => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.saveVectorStoreConfig - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
const insertIntoVectorStore = async ({ appDataSource, componentNodes, telemetry, data, isStrictSave }) => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.insertIntoVectorStore - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
...
const insertIntoVectorStoreMiddleware = async (data, isStrictSave = true) => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.insertIntoVectorStoreMiddleware - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
const _insertIntoVectorStoreWorkerThread = async (appDataSource, componentNodes, telemetry, data, isStrictSave = true) => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices._insertIntoVectorStoreWorkerThread - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
...
const getEmbeddingProviders = async () => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.getEmbeddingProviders - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
...
const getVectorStoreProviders = async () => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.getVectorStoreProviders - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
// Get all component nodes - Vector Stores
const getRecordManagerProviders = async () => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.getRecordManagerProviders - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
const queryVectorStore = async (data) => {
    try {
        ...
        if (!entity) {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Document store ${data.storeId} not found`);
        }
        const options = {
            chatflowid: (0, uuid_1.v4)(),
            appDataSource: appServer.AppDataSource,
        ...
        if (!entity.embeddingConfig) {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Embedding for ${data.storeId} is not configured`);
        }
        if (!entity.vectorStoreConfig) {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Vector Store for ${data.storeId} is not configured`);
        }
        const embeddingConfig = JSON.parse(entity.embeddingConfig);
        ...
        if (!retriever) {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Failed to create retriever`);
        }
        const startMillis = Date.now();
        const results = await retriever.invoke(data.query, undefined);
        if (!results) {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Failed to retrieve results`);
        }
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.queryVectorStore - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
const _createEmbeddingsObject = async (componentNodes, data, options, upsertHistory) => {
    ...
    if (!embeddingObj) {
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Failed to create EmbeddingObj`);
    }
    return embeddingObj;
};
const _createRecordManagerObject = async (componentNodes, data, options, upsertHistory) => {
    ...
    if (!recordManagerObj) {
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Failed to create RecordManager obj`);
    }
...
const upsertDocStore = async (appDataSource, componentNodes, telemetry, storeId, data, files = [], isRefreshExisting = false) => {
    ...
    if (data.metadata) {
        try {
            ...
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.BAD_REQUEST, `Error: Invalid metadata`);
        }
    }
    ...
    if (docId) {
        ...
        if (!loader) {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.NOT_FOUND, `Document loader ${docId} not found`);
        }
        // Loader
    ...
    if (files.length) {
        ...
        for (const file of files) {
            const fileNames = [];
            const fileBuffer = await (0, thub_components_1.getFileFromUpload)(file.path ?? file.key);
            // Address file name with special characters: https://github.com/expressjs/multer/issues/1104
            file.originalname = Buffer.from(file.originalname, 'latin1').toString('utf8');
            try {
                await (0, thub_components_1.addArrayFilesToStorage)(file.mimetype, fileBuffer, file.originalname, fileNames, constants_1.DOCUMENT_STORE_BASE_FOLDER, storeId);
            }
            catch (error) {
                continue;
            }
            ...
            const fileInputFieldFromMimeType = (0, thub_components_1.mapMimeTypeToInputField)(file.mimetype);
            const fileExtension = path.extname(file.originalname);
            const fileInputFieldFromExt = (0, thub_components_1.mapExtToInputField)(fileExtension);
            ...
            await (0, thub_components_1.removeSpecificFileFromUpload)(file.path ?? file.key);
        }
        loaderConfig = {
            ...loaderConfig,
            ...filesLoaderConfig
    ...
    if (!loaderName || !loaderId || !loaderConfig) {
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Loader not configured`);
    }
    if (!vectorStoreName || !vectorStoreConfig) {
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Vector store not configured`);
    }
    if (!embeddingName || !embeddingConfig) {
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Embedding not configured`);
    }
    ...
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.upsertDocStore - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
...
const upsertDocStoreMiddleware = async (storeId, data, files = []) => {
    ...
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.upsertDocStoreMiddleware - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
const refreshDocStoreMiddleware = async (storeId, data) => {
    ...
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.refreshDocStoreMiddleware - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
const generateDocStoreToolDesc = async (docStoreId, selectedChatModel) => {
    try {
        ...
        if (!chunks?.length) {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.NOT_FOUND, `DocumentStore ${docStoreId} chunks not found`);
        }
        ...
        if (selectedChatModel && Object.keys(selectedChatModel).length > 0) {
            ...
            const newNodeInstance = new nodeModule.nodeClass();
            const nodeData = {
                credential: selectedChatModel.credential || selectedChatModel.inputs['THUB_CREDENTIAL_ID'] || undefined,
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.generateDocStoreToolDesc - Error generating tool description`);
    }
    catch (error) {
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.generateDocStoreToolDesc - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
