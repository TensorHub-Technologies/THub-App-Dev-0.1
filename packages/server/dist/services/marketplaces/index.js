...
const getAllTemplates = async () => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: marketplacesService.getAllTemplates - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
const deleteCustomTemplate = async (templateId) => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: marketplacesService.deleteCustomTemplate - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
const getAllCustomTemplates = async () => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: marketplacesService.getAllCustomTemplates - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
const saveCustomTemplate = async (body) => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: marketplacesService.saveCustomTemplate - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
