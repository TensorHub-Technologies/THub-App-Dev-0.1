...
const getAllLeads = async (chatflowid) => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: leadsService.getAllLeads - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
const createLead = async (body) => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: leadsService.createLead - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
exports.default = {
    createLead,
