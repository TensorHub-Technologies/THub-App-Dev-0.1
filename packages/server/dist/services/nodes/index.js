...
const getAllNodes = async () => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: nodesService.getAllNodes - ${(0, utils_2.getErrorMessage)(error)}`);
    }
};
...
const getAllNodesForCategory = async (category) => {
    try {
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: nodesService.getAllNodesForCategory - ${(0, utils_2.getErrorMessage)(error)}`);
    }
};
...
const getNodeByName = async (nodeName) => {
    try {
        ...
        if (Object.prototype.hasOwnProperty.call(appServer.nodesPool.componentNodes, nodeName)) {
            ...
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.NOT_FOUND, `Node ${nodeName} not found`);
        }
    }
    catch (error) {
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: nodesService.getAllNodes - ${(0, utils_2.getErrorMessage)(error)}`);
    ...
    try {
        ...
        if (Object.prototype.hasOwnProperty.call(appServer.nodesPool.componentNodes, nodeName)) {
            ...
            if (nodeInstance.icon === undefined) {
                throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.NOT_FOUND, `Node ${nodeName} icon not found`);
            }
            if (nodeInstance.icon.endsWith('.svg') || nodeInstance.icon.endsWith('.png') || nodeInstance.icon.endsWith('.jpg')) {
                ...
                throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Node ${nodeName} icon is missing icon`);
            }
        }
        else {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.NOT_FOUND, `Node ${nodeName} not found`);
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: nodesService.getSingleNodeIcon - ${(0, utils_2.getErrorMessage)(error)}`);
    }
};
const getSingleNodeAsyncOptions = async (nodeName, requestBody, tenantId) => {
    try {
        const appServer = (0, getRunningExpressApp_1.getRunningExpressApp)();
        ...
        throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: nodesService.getSingleNodeAsyncOptions - ${(0, utils_2.getErrorMessage)(error)}`);
    }
};
...
const executeCustomFunction = async (requestBody) => {
    ...
    if (process.env.MODE === Interface_1.MODE.QUEUE) {
        ...
        logger_1.default.debug(`[server]: Execute Custom Function Job added to queue: ${job.id}`);
