...
const createDocumentStore = async (req, res, next) => {
    try {
        if (typeof req.body === 'undefined') {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: documentStoreController.createDocumentStore - body not provided!`);
        }
        const body = req.body;
...
const getAllDocumentStores = async (req, res, next) => {
    try {
        ...
        const apiResponse = await documentstore_1.default.getAllDocumentStores(page, limit, tenantId);
...
const deleteLoaderFromDocumentStore = async (req, res, next) => {
    try {
        ...
        if (!storeId || !loaderId) {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: documentStoreController.deleteLoaderFromDocumentStore - missing storeId or loaderId.`);
        }
...
const getDocumentStoreById = async (req, res, next) => {
    try {
        if (typeof req.params.id === 'undefined' || req.params.id === '') {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: documentStoreController.getDocumentStoreById - id not provided!`);
        }
...
const getDocumentStoreFileChunks = async (req, res, next) => {
    try {
        if (typeof req.params.storeId === 'undefined' || req.params.storeId === '') {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: documentStoreController.getDocumentStoreFileChunks - storeId not provided!`);
        }
        if (typeof req.params.fileId === 'undefined' || req.params.fileId === '') {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: documentStoreController.getDocumentStoreFileChunks - fileId not provided!`);
        }
...
const deleteDocumentStoreFileChunk = async (req, res, next) => {
    try {
        if (typeof req.params.storeId === 'undefined' || req.params.storeId === '') {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: documentStoreController.deleteDocumentStoreFileChunk - storeId not provided!`);
        }
        if (typeof req.params.loaderId === 'undefined' || req.params.loaderId === '') {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: documentStoreController.deleteDocumentStoreFileChunk - loaderId not provided!`);
        }
        if (typeof req.params.chunkId === 'undefined' || req.params.chunkId === '') {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: documentStoreController.deleteDocumentStoreFileChunk - chunkId not provided!`);
        }
...
const editDocumentStoreFileChunk = async (req, res, next) => {
    try {
        if (typeof req.params.storeId === 'undefined' || req.params.storeId === '') {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: documentStoreController.editDocumentStoreFileChunk - storeId not provided!`);
        }
        if (typeof req.params.loaderId === 'undefined' || req.params.loaderId === '') {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: documentStoreController.editDocumentStoreFileChunk - loaderId not provided!`);
        }
        if (typeof req.params.chunkId === 'undefined' || req.params.chunkId === '') {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: documentStoreController.editDocumentStoreFileChunk - chunkId not provided!`);
        }
        const body = req.body;
        if (typeof body === 'undefined') {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: documentStoreController.editDocumentStoreFileChunk - body not provided!`);
        }
...
const saveProcessingLoader = async (req, res, next) => {
    try {
        ...
        if (typeof req.body === 'undefined') {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: documentStoreController.saveProcessingLoader - body not provided!`);
        }
        const body = req.body;
...
const processLoader = async (req, res, next) => {
    try {
        if (typeof req.params.loaderId === 'undefined' || req.params.loaderId === '') {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: documentStoreController.processLoader - loaderId not provided!`);
        }
        if (typeof req.body === 'undefined') {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: documentStoreController.processLoader - body not provided!`);
        }
        const docLoaderId = req.params.loaderId;
        const body = req.body;
        const isInternalRequest = req.headers['x-request-from'] === 'internal';
        const apiResponse = await documentstore_1.default.processLoaderMiddleware(body, docLoaderId, isInternalRequest);
        return res.json(apiResponse);
    }
    catch (error) {
        next(error);
...
const updateDocumentStore = async (req, res, next) => {
    try {
        if (typeof req.params.id === 'undefined' || req.params.id === '') {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: documentStoreController.updateDocumentStore - storeId not provided!`);
        }
        if (typeof req.body === 'undefined') {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: documentStoreController.updateDocumentStore - body not provided!`);
        }
        const store = await documentstore_1.default.getDocumentStoreById(req.params.id);
        if (!store) {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.NOT_FOUND, `Error: documentStoreController.updateDocumentStore - DocumentStore ${req.params.id} not found in the database`);
        }
        const body = req.body;
...
const deleteDocumentStore = async (req, res, next) => {
    try {
        if (typeof req.params.id === 'undefined' || req.params.id === '') {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: documentStoreController.deleteDocumentStore - storeId not provided!`);
        }
...
const previewFileChunks = async (req, res, next) => {
    try {
        if (typeof req.body === 'undefined') {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: documentStoreController.previewFileChunks - body not provided!`);
        }
        const body = req.body;
        body.preview = true;
...
const insertIntoVectorStore = async (req, res, next) => {
    try {
        ...
        const body = req.body;
        const apiResponse = await documentstore_1.default.insertIntoVectorStoreMiddleware(body, false);
        (0, getRunningExpressApp_1.getRunningExpressApp)().metricsProvider?.incrementCounter(Interface_Metrics_1.THUB_METRIC_COUNTERS.VECTORSTORE_UPSERT, {
            status: Interface_Metrics_1.THUB_COUNTER_STATUS.SUCCESS
        });
        return res.json(Interface_1.DocumentStoreDTO.fromEntity(apiResponse));
    }
    catch (error) {
        (0, getRunningExpressApp_1.getRunningExpressApp)().metricsProvider?.incrementCounter(Interface_Metrics_1.THUB_METRIC_COUNTERS.VECTORSTORE_UPSERT, {
            status: Interface_Metrics_1.THUB_COUNTER_STATUS.FAILURE
        });
        next(error);
    }
};
...
const deleteVectorStoreFromStore = async (req, res, next) => {
    try {
        if (typeof req.params.storeId === 'undefined' || req.params.storeId === '') {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: documentStoreController.deleteVectorStoreFromStore - storeId not provided!`);
        }
...
const upsertDocStoreMiddleware = async (req, res, next) => {
    try {
        if (typeof req.params.id === 'undefined' || req.params.id === '') {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: documentStoreController.upsertDocStoreMiddleware - storeId not provided!`);
        }
        if (typeof req.body === 'undefined') {
...
const refreshDocStoreMiddleware = async (req, res, next) => {
    try {
        if (typeof req.params.id === 'undefined' || req.params.id === '') {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: documentStoreController.refreshDocStoreMiddleware - storeId not provided!`);
        }
        const body = req.body;
...
const generateDocStoreToolDesc = async (req, res, next) => {
    try {
        if (typeof req.params.id === 'undefined' || req.params.id === '') {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: documentStoreController.generateDocStoreToolDesc - storeId not provided!`);
        }
        if (typeof req.body === 'undefined') {
...
const getDocStoreConfigs = async (req, res, next) => {
    try {
        if (typeof req.params.id === 'undefined' || req.params.id === '') {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: documentStoreController.getDocStoreConfigs - storeId not provided!`);
        }
        if (typeof req.params.loaderId === 'undefined' || req.params.loaderId === '') {
            throw new internalTHubError_1.InternalTHubError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: documentStoreController.getDocStoreConfigs - doc loader Id not provided!`);
        }
