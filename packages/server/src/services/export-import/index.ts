...
import assistantService from '../assistants.js'
import chatMessagesService from '../chat-messages.js'
import chatflowService from '../chatflows.js'
import documenStoreService from '../documentstore.js'
import executionService from '../executions.js'
import marketplacesService from '../marketplaces.js'
import toolsService from '../tools.js'
import variableService from '../variables.js'
...
const exportData = async (exportInput: ExportInput, tenantId: string): Promise<{ FileDefaultName: string } & ExportData> => {
    try {
        ...
        let Variable: Variable[] = exportInput.variable === true ? await variableService.getAllVariables(tenantId) : []
