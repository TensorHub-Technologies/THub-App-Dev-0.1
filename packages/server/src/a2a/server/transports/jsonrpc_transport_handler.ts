...
export class JsonRpcTransportHandler {
     ...
     */
    public async handle(requestBody: any): Promise<JSONRPCResponse | AsyncGenerator<JSONRPCResponse, void, undefined>> {
            ...
            if (method === 'message/stream' || method === 'tasks/resubscribe') {
                ...
                switch (method) {
                    ...
                    case 'tasks/pushNotificationConfig/set':
                        result = await this.requestHandler.setTaskPushNotificationConfig(rpcRequest.params)
                        break
                    case 'tasks/pushNotificationConfig/get':
                        result = await this.requestHandler.getTaskPushNotificationConfig(rpcRequest.params)
                        break
                    case 'tasks/pushNotificationConfig/delete':
                        await this.requestHandler.deleteTaskPushNotificationConfig(rpcRequest.params)
                        result = null
                        break
                    case 'tasks/pushNotificationConfig/list':
                        result = await this.requestHandler.listTaskPushNotificationConfigs(rpcRequest.params)
                        break
                    default:
