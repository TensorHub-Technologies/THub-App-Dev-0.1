...
export const defaultThemeConfig = {
    ...
    disclaimer: {
        title: 'Disclaimer',
        message: 'By using this chatbot, you agree to the <a target="_blank" href="https://thubai.com/terms">Terms & Condition</a>',
        textColor: 'black',
        buttonColor: '#3b82f6',
                        ...
                        <>
                            <span>
                                ...
                                <p>
                                    ...
                                    <a rel='noreferrer' target='_blank' href='https://www.npmjs.com/package/thub-embed?activeTab=versions'>
                                        version
                                    </a>
                                    :&nbsp;<code>{`https://cdn.jsdelivr.net/npm/thub-embed@<version>/dist/web.js`}</code>
                                </p>
                            </span>
