                    ...
                    title={
                        ...
                        >
                            <IconButton
                                ...
                                onMouseLeave={(e) => (e.currentTarget.firstChild.style.color = customization?.isDarkMode ? '#fff' : '#000')}
                            >
                                {nodeMinMax ? (
                                    <HorizontalRuleIcon id='MinimizeIcon' style={{ color: customization?.isDarkMode ? '#fff' : '#000' }} />
                                ) : (
