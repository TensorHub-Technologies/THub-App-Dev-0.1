...
export const updateOutdatedNodeData = (newComponentNodeData, existingComponentNodeData, isAgentflow) => {
    ...
    const isAgentFlowV2 = newComponentNodeData.category === 'Agent Pipeline' || existingComponentNodeData.category === 'Agent Pipeline'
...
export const updateOutdatedNodeEdge = (newComponentNodeData, edges) => {
    ...
    const isAgentFlowV2 = newComponentNodeData.category === 'Agent Pipeline'
...
export const getAvailableNodesForVariable = (nodes, edges, target, targetHandle, includesStart = false) => {
    ...
    const isAgentFlowV2 = nodes.find((nd) => nd.id === target)?.data?.category === 'Agent Pipeline'
