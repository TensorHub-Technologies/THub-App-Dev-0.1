...
const THubGoogleAICacheManager_1 = __importDefault(require("./THubGoogleAICacheManager"));
class GoogleGenerativeAIContextCache {
    ...
    constructor() {
        ...
        this.category = 'Cache';
        this.baseClasses = [this.type, ...(0, src_1.getBaseClasses)(THubGoogleAICacheManager_1.default)];
        this.inputs = [
            {
                label: 'TTL',
                name: 'ttl',
    ...
    async init(nodeData, _, options) {
        ...
        const manager = new THubGoogleAICacheManager_1.default(apiKey);
