...
const THubChatOpenAI_1 = require("../../chatmodels/ChatOpenAI/THubChatOpenAI");
const THubChatAnthropic_1 = require("../../chatmodels/ChatAnthropic/THubChatAnthropic");
const multiModalUtils_1 = require("../../../src/multiModalUtils");
const THubChatGoogleGenerativeAI_1 = require("../../chatmodels/ChatGoogleGenerativeAI/THubChatGoogleGenerativeAI");
...
class Supervisor_MultiAgents {
    ...
    async init(nodeData, _, options) {
        ...
        async function createTeamSupervisor(llm, systemPrompt, members) {
            ...
            else if (llm instanceof THubChatAnthropic_1.ChatAnthropic) {
            ...
            else if (llm instanceof THubChatOpenAI_1.ChatOpenAI) {
                let prompt = prompts_1.ChatPromptTemplate.fromMessages([
                    ['system', systemPrompt],
                    new prompts_1.MessagesPlaceholder('messages'),
                    ['human', userPrompt]
            ...
            else if (llm instanceof THubChatGoogleGenerativeAI_1.ChatGoogleGenerativeAI) {
                /*
