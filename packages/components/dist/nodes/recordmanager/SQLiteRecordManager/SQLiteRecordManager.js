...
class SQLiteRecordManager_RecordManager {
    ...
    constructor() {
        ...
        this.inputs = [
            /*{
                ...
                type: 'string',
                placeholder: 'C:\\Users\\User\\.thub\\database.sqlite'
            },*/
            {
    ...
    async init(nodeData, _, options) {
        ...
        const database = path_1.default.join(process.env.DATABASE_PATH ?? path_1.default.join((0, utils_1.getUserHome)(), '.thub'), 'database.sqlite');
        const sqliteOptions = {
            database,
