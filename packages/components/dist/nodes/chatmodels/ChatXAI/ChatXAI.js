...
const THubChatXAI_1 = require("./THubChatXAI");
class ChatXAI_ChatModels {
    ...
    constructor() {
        ...
        this.baseClasses = [this.type, ...(0, utils_1.getBaseClasses)(THubChatXAI_1.ChatXAI)];
        this.credential = {
        ...
        this.inputs = [
            ...
            },
            {
                ...
                type: 'boolean',
                description: 'Allow image input. Refer to the <a href="https://docs.thubai.com/using-thub/uploads#image" target="_blank">docs</a> for more details.',
                default: false,
                optional: true
            }
        ];
    ...
    async init(nodeData, _, options) {
        ...
        const model = new THubChatXAI_1.ChatXAI(nodeData.id, obj);
