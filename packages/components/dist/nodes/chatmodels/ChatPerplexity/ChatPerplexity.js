...
const THubChatPerplexity_1 = require("./THubChatPerplexity");
...
class ChatPerplexity_ChatModels {
    ...
    async init(nodeData, _, options) {
        ...
        if (proxyUrl) {
            console.warn('Proxy configuration for ChatPerplexity might require adjustments to THubChatPerplexity wrapper.');
        }
        const perplexityModel = new THubChatPerplexity_1.ChatPerplexity(nodeData.id, obj);
