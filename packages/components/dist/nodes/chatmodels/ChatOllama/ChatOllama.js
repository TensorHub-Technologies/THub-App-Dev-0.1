...
const THubChatOllama_1 = require("./THubChatOllama");
class ChatOllama_ChatModels {
    ...
    constructor() {
        ...
        this.baseClasses = [this.type, ...(0, utils_1.getBaseClasses)(THubChatOllama_1.ChatOllama)];
        this.inputs = [
            {
                label: 'Cache',
                name: 'cache',
    ...
    async init(nodeData) {
        ...
        const model = new THubChatOllama_1.ChatOllama(nodeData.id, obj);
