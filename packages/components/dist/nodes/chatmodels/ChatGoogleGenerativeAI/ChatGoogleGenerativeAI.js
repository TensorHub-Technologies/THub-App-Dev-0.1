...
const THubChatGoogleGenerativeAI_1 = require("./THubChatGoogleGenerativeAI");
class GoogleGenerativeAI_ChatModels {
    ...
    constructor() {
        ...
        this.baseClasses = [this.type, ...(0, utils_1.getBaseClasses)(THubChatGoogleGenerativeAI_1.ChatGoogleGenerativeAI)];
        this.credential = {
    ...
    async init(nodeData, _, options) {
        ...
        const model = new THubChatGoogleGenerativeAI_1.ChatGoogleGenerativeAI(nodeData.id, obj);
