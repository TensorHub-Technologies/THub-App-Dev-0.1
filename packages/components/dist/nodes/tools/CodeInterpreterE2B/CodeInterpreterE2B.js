...
class E2BTool extends tools_1.StructuredTool {
    ...
    chatflowid;
    flowObj;
    templateCodeInterpreterE2B;
    domainCodeInterpreterE2B;
    constructor(options) {
        super(options);
                ...
                for (const result of execution.results) {
                    for (const key in result) {
                        ...
                        if (key === 'png') {
                            ...
                            const path = await (0, storageUtils_1.addSingleFileToStorage)('image/png', pngData, filename, this.chatflowid, flowConfig.chatId);
                            ...
                            const path = await (0, storageUtils_1.addSingleFileToStorage)('image/jpg', jpegData, filename, this.chatflowid, flowConfig.chatId);
