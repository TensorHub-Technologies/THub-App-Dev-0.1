...
const createGoogleCalendarTools = (args) => {
    ...
    if (actions.includes('queryFreebusy')) {
        tools.push(new QueryFreebusyTool({
            accessToken,
