...
export declare abstract class THubMemory extends BufferMemory implements MemoryMethods {
...
export declare abstract class THubWindowMemory extends BufferWindowMemory implements MemoryMethods {
    abstract getChatMessages(overrideSessionId?: string, returnBaseMessages?: boolean, prependMessages?: IMessage[]): Promise<IMessage[] | BaseMessage[]>;
    abstract addChatMessages(msgArray: {
        text: string;
        type: MessageType;
...
export declare abstract class THubSummaryMemory extends ConversationSummaryMemory implements MemoryMethods {
    abstract getChatMessages(overrideSessionId?: string, returnBaseMessages?: boolean, prependMessages?: IMessage[]): Promise<IMessage[] | BaseMessage[]>;
    abstract addChatMessages(msgArray: {
        text: string;
        type: MessageType;
...
export declare abstract class THubSummaryBufferMemory extends ConversationSummaryBufferMemory implements MemoryMethods {
    abstract getChatMessages(overrideSessionId?: string, returnBaseMessages?: boolean, prependMessages?: IMessage[]): Promise<IMessage[] | BaseMessage[]>;
    abstract addChatMessages(msgArray: {
        text: string;
        type: MessageType;
