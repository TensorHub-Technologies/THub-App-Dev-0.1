...
Azure OpenAI Embedding Model integration for THub
...
Source code in this repository is made available under the [Apache License Version 2.0](https://github.com/THub/THub/blob/master/LICENSE.md).
