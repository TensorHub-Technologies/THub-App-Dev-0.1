...
import { AzureChatOpenAI } from './THubAzureChatOpenAI'
    ...
    constructor() {
        ...
        this.inputs = [
            ...
            },
            {
                ...
                type: 'boolean',
                description:
                    'Allow image input. Refer to the <a href="https://docs.thubai.com/using-thub/uploads#image" target="_blank">docs</a> for more details.',
                default: false,
                optional: true
            },
            {
