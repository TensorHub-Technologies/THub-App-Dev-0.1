...
import THubGoogleAICacheManager from './THubGoogleAICacheManager'
...
class GoogleGenerativeAIContextCache implements INode {
    ...
    constructor() {
        ...
        this.category = 'Cache'
        this.baseClasses = [this.type, ...getBaseClasses(THubGoogleAICacheManager)]
        this.inputs = [
            {
                label: 'TTL',
                name: 'ttl',
    ...
    async init(nodeData: INodeData, _: string, options: ICommonObject): Promise<any> {
        ...
        const manager = new THubGoogleAICacheManager(apiKey)
