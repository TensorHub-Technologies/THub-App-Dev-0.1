...
import { getCredentialData, getCredentialParam, getEnvironmentVariable } from './utils.js'
import { EvaluationRunTracer } from '../evaluation/EvaluationRunTracer.js'
import { EvaluationRunTracerLlama } from '../evaluation/EvaluationRunTracerLlama.js'
import { ICommonObject, IDatabaseEntity, INodeData, IServerSideEventStreamer } from './Interface.js'
...
export class AnalyticHandler {
    ...
    async onChainStart(name: string, input: string, parentIds?: ICommonObject) {
        ...
        if (Object.prototype.hasOwnProperty.call(this.handlers, 'arize')) {
            ...
            if (!parentIds || !Object.keys(parentIds).length) {
                rootSpan = tracer ? tracer.startSpan('THub') : undefined
                if (rootSpan) {
